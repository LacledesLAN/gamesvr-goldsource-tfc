...
First off, thank you for considering contributing to `gamesvr-goldsource-tfc`. It's people like you that make Laclede's LAN such a great community.

## Did you find a bug or have questions?

Let us know by using [GitHub issues](https://github.com/LacledesLAN/gamesvr-goldsource-tfc/issues) on this repository.
